 ...
 *         实现可循环，可轮播的viewpager
 */
public class CycleImageViewPager extends Fragment implements OnPageChangeListener {
    ...
    public void setIntData(List<ImageView> views, int[] list, ImageCycleViewListener listener) {
     ...
     */
    public void setData(List<ImageView> views, int[] list, ImageCycleViewListener listener, int showPosition) {
            ...
            if (mImageCycleViewListener != null) {
                v.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        mImageCycleViewListener.onImageClick(intInfos[currentPosition - 1], currentPosition, v);
                    }
                });
            }
            container.addView(v);
    ...
    public interface ImageCycleViewListener {
         ...
         * 单击图片事件
         */
        void onImageClick(int info, int postion, View imageView);
    }
}